...
class UserCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["username", "password", "role"]
    ...
    def role_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(patient|doctor|admin)$", value):
            raise ValueError(r"must validate the regular expression /^(patient|doctor|admin)$/")
        return value
